...
public class SpeechBubble : MonoBehaviour
{
    ...
    public virtual void UpdateText(int requireRedBin, int requireCream)
    {
        ...
        {
            case BunType.cream:
                NumberSpriteRender.sprite = numberSprites[requireCream - 1];
                break;
            case BunType.redBin:
                NumberSpriteRender.sprite = numberSprites[requireRedBin - 1];
                break;
            case BunType.both:
                NumberSpriteRender.sprite = numberSprites[requireRedBin - 1];
                NumberSpriteRender_cream.sprite = numberSprites[requireCream - 1];
                break;
        }
    }
